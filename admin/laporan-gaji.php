      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <a href="egaji.php" class="btn btn-success mb-3"><em class="fa fa-file-excel"></em> Eksport Excel</a>
                <a href="cgaji.php" target="_blank" class="btn btn-danger mb-3"><em class="fa fa-print"></em> Cetak Laporan</a>
